...
// const treatmentCosts: TreatmentCost[] = [
//   {
//     svg: "/img/price-1.svg",
//     name: "人工授精",
//     own: "- 自費診療 -",
//     ownDetail: ["・診察、検査、薬代：30,000円", "・人工授精1回：20,000円"],
//     ownPrice: "50,000円",
//     insurance: "- 保険適用 -",
//     insuranceDetail: [
//       "・診察、検査、薬代：9,500円",
...
//       "・一般不妊管理料：750円",
//     ],
//     insurancePrice: "15,710円",
//   },
//   {
//     svg: "/img/price-2.svg",
//     name: "体外受精",
//     own: "- 自費診療 -",
//     ownDetail: ["data", "data2", "data3"],
//     ownPrice: "¥6900 / 月",
//     insurance: "- 保険適用 -",
//     insuranceDetail: [
//       "＜採卵＞",
...
//       "・治療開始時の妻の年齢が40歳以上43歳未満：1子につき最大3回まで",
//     ],
//     insurancePrice: "727,200円",
//   },
//   {
//     svg: "/img/price-3.svg",
//     name: "顕微授精",
//     own: "- 自費診療 -",
//     ownDetail: ["Free support 24/7", "Editable database", "5 Email accounts"],
//     ownPrice: "¥9900 / 月",
//     insurance: "- 保険適用 -",
//     insuranceDetail: [
//       "Free support 24/7",
...
//       "・治療開始時の妻の年齢が40歳以上43歳未満：1子につき最大3回まで",
//     ],
//     insurancePrice: "30,000円",
//   },
// ];

// // 治療費一覧
// const CostCard: React.FC<TreatmentCost> = ({
//   name,
//   ownDetail,
//   ownPrice,
//   svg,
...
//     <div className="flex flex-col items-center px-10 py-6 w-[290px] m-4 bg-white rounded-[35px] shadow-md">
//       {/* svg画像 */}
//       <img src={svg} alt="" className="w-[190px] mb-6" />
//       {/* 治療名 */}
//       <h3 className="text-xl font-extrabold mb-6">{name}</h3>

//       {/* 自費診療 */}
//       <h3 className="text-base font-extrabold mb-1">{own}</h3>

//       {/* 治療内容 自費診療 */}
//       <ul className="mb-2">
//         {ownDetail.map((ownDetail, index) => (
//           <li key={index} className="flex items-center">
//             <span className="text-sm">{ownDetail}</span>
//           </li>
//         ))}
//       </ul>

//       {/* 価格 */}
//       <div className="text-2xl font-bold border-b-2 w-[170px] text-center border-gray-300 pb-8 mb-8">
//         {ownPrice}
//       </div>

//       {/* 保険適用 */}
//       <h3 className="text-base font-extrabold mb-1">{insurance}</h3>

//       {/* 治療内容 保険適用 */}
//       <ul className="">
//         {insuranceDetail.map((insuranceDetail, index) => (
//           <li key={index} className="flex items-center">
//             <span className="text-sm">{insuranceDetail}</span>
//           </li>
//         ))}
//       </ul>

//       {/* 適用条件 */}
//       <h3 className="text-base font-extrabold">{requirement}</h3>

//       {/* 適用条件 詳細 */}
//       <ul className="">
//         {requirementDetail &&
//           requirementDetail.map((detail, index) => (
//             <li key={index} className="flex items-center">
...
//       {/* 価格 保険適用 */}
//       <div className="text-2xl font-bold pb-3 mt-2">{insurancePrice}</div>
//     </div>
//   );
// };
...
//         </div>
//         <div className="flex-grow flex flex-col items-center">
//           <h2 className="text-3xl font-bold mb-2 pt-8 mb-6">治療金額目安</h2>
//           <div className="flex justify-center items-start items-stretch">
//             {treatmentCosts.map((option, index1) => (
//               <CostCard key={index1} {...option} />
//             ))}
//           </div>
